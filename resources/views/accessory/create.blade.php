...
<div class='container'>
    ...
    <div class="mr-2 ml-2">
        ...
        <div class="row justify-content-center pt-3 create">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><strong>Register Accessory</strong></div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="/accessory">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control"  id="availability" name="availability" onchange="showMore()" value="{{ old('availability') }}">
                                        <option disabled selected value> -- Select an option -- </option>
                            ...
                            <div class="form-group row" id="hide_od">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control"  id="owner_department" name="owner_department" value="{{ old('owner_department') }}">
                                        <option disabled selected value> -- Select an option -- </option>
                            ...
                            <div class="form-group row" id="hide_l">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control"  id="location" name="location" value="{{ old('location') }}">
                                        <option disabled selected value> -- Select an option -- </option>
