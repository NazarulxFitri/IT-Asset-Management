...
<div class='container'>
    ...
    <div class="mr-2 ml-2">
        ...
        <div class="row justify-content-center pt-3">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header bg-dark text-white">Edit Monitor</div>

                    <div class="card-body">
                        <form method="post" action="/monitor/update/{{ $monitor->id }}">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="serial_number" type="text" class="form-control @error('serial_number') is-invalid @enderror" name="serial_number" 
                                           value="{{ $monitor->serial_number }}" required autocomplete="serial_number" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" value="{{ $monitor->brand }}" id="brand" name="brand">
                                        <option disabled selected value>{{ $monitor->brand }} | Please re-confirm this field</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="model" type="text" class="form-control @error('model') is-invalid @enderror" name="model" 
                                           value="{{ $monitor->model }}" required autocomplete="model" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="color" type="text" class="form-control @error('color') is-invalid @enderror" name="color" 
                                           value="{{ $monitor->color }}" required autocomplete="color" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control"  id="condition" name="condition" value="{{ old('condition') }}" required>
                                        <option disabled selected value>{{ $monitor->condition }} | Please re-confirm this field</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="owner_name" type="text" class="form-control @error('owner_name') is-invalid @enderror" name="owner_name" 
                                           value="{{ $monitor->owner_name }}" required autocomplete="owner_name" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control"  id="owner_department" name="owner_department" value="{{ old('owner_department') }}" required>
                                        <option disabled selected value>{{ $monitor->owner_department }} | Please re-confirm this field</option>
